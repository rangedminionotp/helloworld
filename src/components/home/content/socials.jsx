...
function Socials() {
    ...
    return (
        <div id='social-links'>
            ...
            <div id={text} onClick={(e)=>handleClick(e)}>
                <div class='social-btn flex-center' id={socialIcons[index]}>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d={paths[index]}/></svg><span>@{socialId[index]}</span>
                </div>
            </div> 
            ))}
        </div>
